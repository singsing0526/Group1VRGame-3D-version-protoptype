...
public class ALIyerEdonAssets_Lighting : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        if (EditorPrefs.GetInt("dontShow_lb2Lit") == 3)
            dontShow = true;
        if (EditorPrefs.GetInt("dontShow_lb2Lit") != 3)
            dontShow = false;
    ...
    private void OnGUI()
    {
        ...
        Texture2D border = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/border.psd") as Texture2D;
        Texture2D ad1 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad1.psd") as Texture2D;
        Texture2D ad2 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad2.psd") as Texture2D;
        Texture2D ad3 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad3.psd") as Texture2D;
        Texture2D ad4 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad4.psd") as Texture2D;
        Texture2D ad5 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad5.psd") as Texture2D;
        Texture2D ad6 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad6.psd") as Texture2D;
        Texture2D ad7 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad7.psd") as Texture2D;
        Texture2D ad8 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad8.psd") as Texture2D;
        Texture2D ad9 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad9.psd") as Texture2D;
        Texture2D ad10 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad10.psd") as Texture2D;
        Texture2D ad11 = EditorGUIUtility.Load("Assets/LightingBox2/Scripts/Editor/Textures/UI/Ads/ad11.psd") as Texture2D;
        ...
        {
            if (dontShow == true)            
                EditorPrefs.SetInt("dontShow_lb2Lit", 3); // 3 == true
            if (dontShow == false)
                EditorPrefs.SetInt("dontShow_lb2Lit", 0); // 0 = false
        }
...
public class Startup
{
    static Startup()
    {
        EditorPrefs.SetInt("showCounts_lb2Lit", EditorPrefs.GetInt("showCounts_lb2Lit") + 1);
        if (EditorPrefs.GetInt("showCounts_lb2Lit") < 2)
        { 
        ...
        {
            if(EditorPrefs.GetInt("showCounts_lb2Lit") >= 30)
               EditorPrefs.SetInt("showCounts_lb2Lit", 0);
        }            
    }
} 
